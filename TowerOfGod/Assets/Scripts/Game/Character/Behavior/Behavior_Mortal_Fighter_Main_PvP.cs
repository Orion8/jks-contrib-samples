...
public class Behavior_Mortal_Fighter_Main_PvP : Behavior_Mortal_Fighter_Main
{
...
//			{
//				Invoke("forceIdle", 0.5f); //jks give time so that all weapons can be disappeared. 
//				setActive_Delayed(false, 0.7f); //jks delay deactivation time to pass blending time
//			}
