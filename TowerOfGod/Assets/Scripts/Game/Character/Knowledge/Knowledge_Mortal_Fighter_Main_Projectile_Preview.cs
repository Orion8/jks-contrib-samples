...
public class Knowledge_Mortal_Fighter_Main_Projectile_Preview : Knowledge_Mortal_Fighter_Main_Projectile
{
...
//			resetPosition();
	...
	public override int getReaction(eHitType hitType)
	{
		...
		if (hitReactionAnimID == 4 || hitReactionAnimID == 5)
			hitReactionAnimID = 1;
	...
	{
		if (Action_Guard_Up) yield break;  //if (Action_RoleSkill) yield break;
