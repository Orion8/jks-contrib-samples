...
public class Knowledge_Mortal_Fighter_Main_Projectile_PvP : Knowledge_Mortal_Fighter_Main_Projectile
{
	void Awake()
	{
	}
...
//	}
	...
	{		
		...
		if (PvpTarget != null)
		{
			...
			StartCoroutine( launcher.spawn(PvpTarget, AttackInfo, AttackType, _weaponType_ForAnimation, reactionDistanceOverride));
